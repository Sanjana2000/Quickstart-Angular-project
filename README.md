...
### Create a new project based on the QuickStart
1. Clone this repo into new project folder. (e.g., my-proj).

git clone https://github.com/angular/quickstart  my-proj
2. cd my-proj
3. We have no intention of updating the source on angular/quickstart. Discard the .git folder..
